...
<% 
                          ...
                          service_provider_dao dao1=new service_provider_dao();
                          java.util.ArrayList<services_pojo> data1=dao1.srvice_fetch();
                                
                              int count=0; 
                              
                                for(services_pojo d: data1)
                                {
					...
					<div class="col-lg-5">
						...
						<div class="slider-text">
							...
							<div class="short-info">
								...
								<h4><%=count%>.Service Provider Details:  </h4>
                                                                <p><strong>Service: </strong><a href="#"><%=obj.getService_name()%></a> </p>
								...
								<p><strong>Duration: </strong><a href="#"><%=obj.getService_duration()%></a></p>
                                                                <p><strong>Location: </strong><a href="#"><%=obj.getLocation()%></a></p>
                                                                 <p><strong>Service Provider Id: </strong><a href="#"><%=obj.getService_pro_id()%></a></p>
                                                               <p><strong>Service Description: </strong><a href="#"><%=obj.getService_description()%></a></p>
                                                                 <br><br>
