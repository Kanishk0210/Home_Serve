   ...
   <!-- CSS -->
    ...
    <script type="text/javascript">
            function AjaxFunction(){
                ...
                var querystring="emailcheck.jsp?email="+email;
			...
			<div class="row text-center">
				...
				<div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
					<div class="user-account">
						<h2>Create Service Provider Account</h2>
                                                <form action="getProvider.jsp" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<input type="text" class="form-control" name="name"  placeholder="Name">
                                                                
							</div>
							<div class="form-group">
								<input type="email" class="form-control" name="email" id="email" onchange="AjaxFunction()" placeholder="Email Id">
                                                                <div id="status"></div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input type="number" class="form-control" name="adharNumber" placeholder="Aadhar Number">
							</div>
                                                        <div class="form-group">
