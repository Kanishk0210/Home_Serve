...
public final class serviceRequest_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 ano=session.getAttribute("email").toString();
    ...
    catch(Exception e)
    {
      ...
      out.write("                                                        \n");
      out.write("                                                       <a href=\"status.jsp?status=Accept&bid=");
      out.print(obj.getBid());
      out.write("\"> <button type=\"submit\" class=\"form-control\" name=\"accept\" >Accept</button></a>\n");
      out.write("                                                       <a href=\"status.jsp?status=Reject&bid=");
      out.print(obj.getBid());
      out.write("\"><button type=\"submit\" class=\"form-control\" name=\"reject\" >Reject</button></a>\n");
      out.write("                                               \n");
      out.write("                                                        <!-- social-links -->\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\n");
      out.write("                                                </div>\n");
