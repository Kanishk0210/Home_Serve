...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<!-- form -->\n");
      out.write("\t\t\t\t\t\t<form action=\"serviceProviderLogin.jsp\">\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"user-option\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"checkbox pull-left\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"logged\"><input type=\"checkbox\" name=\"logged\" id=\"logged\"> Keep me logged in </label>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"pull-right forgot-password\">\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"#\">Forgot password</a>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div><!-- forgot-password -->\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<a href=\"providerreg.jsp\" class=\"btn-primary\">Register Your Service</a>\n");
      out.write("\t\t\t\t</div><!-- user-login -->\t\t\t\n");
      out.write("\t\t\t</div><!-- row -->\t\n");
      out.write("\t\t</div><!-- container -->\n");
      out.write("\t</section><!-- signin-page -->\n");
      out.write("\t\n");
      out.write("\t<!-- footer -->\n");
