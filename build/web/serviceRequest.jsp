                          ...
                          ArrayList<booking_pojo> data=dao.booking_fetch(ano);
                              ...
                              int count=0; 
                                ...
                                for(booking_pojo d: data)
                                {
                                    ...
                                    if(obj.getStatus().equals("Requested"))
                                    {
                                    obj.setCid(d.getCid());
                                obj.setBid(d.getBid());
					...
					<div class="col-lg-5">
						...
						<div class="slider-text">
							...
							<!-- social-links -->
                                                       ...
                                                       <a href="status.jsp?status=Accept&bid=<%=obj.getBid()%>"> <button type="submit" class="form-control" name="accept" >Accept</button></a>
                                                       <a href="status.jsp?status=Reject&bid=<%=obj.getBid()%>"><button type="submit" class="form-control" name="reject" >Reject</button></a>
